package nus.ssf_day17_practice.service;
...
public class FortuneCookie {
	public static final String[] COOKIES = { "With integrity and consistency -- your credits are piling up.",
		...
		public String getCookie(){
			...
			int index = rand.nextInt(COOKIES.length);
		
			return COOKIES[index];
		}
		// return a number of cookies
		public List<String> getCookies(Integer numOfCookies) {
			assert (numOfCookies > 0);
			Random rand = new SecureRandom();
			List<String> cookieList = new ArrayList<>();
			for(Integer i = 0; i < numOfCookies; i++)  {
